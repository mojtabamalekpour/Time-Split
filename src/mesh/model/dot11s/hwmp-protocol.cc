      ...
      if ((*i)->GetDestinationAddress () == Mac48Address::GetBroadcast ())
        {
          ...
          if (
            ...
            /////////////////////////////////////////////////////////////////////////////////////comented by mojio
        	  if(GetAddress() == "00:00:00:00:00:02" || GetAddress() == "00:00:00:00:00:05"){
        		  from = "00:00:00:00:00:01";
        	  }else if(GetAddress() == "00:00:00:00:00:06" || GetAddress() == "00:00:00:00:00:09"){
        		  from = "00:00:00:00:00:05";
        	  }else if(GetAddress() == "00:00:00:00:00:03"){
        		  from = "00:00:00:00:00:02";
        	  }else if(GetAddress() == "00:00:00:00:00:04"){
        		  from = "00:00:00:00:00:03";
        	  }else if(GetAddress() == "00:00:00:00:00:08"){
        		  from = "00:00:00:00:00:04";
        	  }else if(GetAddress() == "00:00:00:00:00:0a" || GetAddress() == "00:00:00:00:00:0d"){
        		  from = "00:00:00:00:00:09";
        	  }else if(GetAddress() == "00:00:00:00:00:0e" || GetAddress() == "00:00:00:00:00:0b"){
        		  from = "00:00:00:00:00:0a";
        	  }else if(GetAddress() == "00:00:00:00:00:07" || GetAddress() == "00:00:00:00:00:0f" || GetAddress() == "00:00:00:00:00:0c"){
        		  from = "00:00:00:00:00:0b";
        	  }else if(GetAddress() == "00:00:00:00:00:0g"){
        		  from = "00:00:00:00:00:0c";
        	  }

        	  std::cout<< "IAM: " <<GetAddress()<< " PAR: "<<from<<" Now: " << Simulator::Now()<<std::endl;
